        ...
        <div>
            ...
            <Box p={5} pb={3} pt={0}>
                ...
                >
                    ...
                    > 
                        {(adminState?.PermisosContex?.Modulos?.Colaboradores?.NuevoIngreso?.Acceso) === true?
                        <CustomTab label="Nuevo Ingreso" value={0}/>
                        :null
                        }   
                        {(adminState?.PermisosContex?.Modulos?.Colaboradores?.Colaboradores?.Acceso) === true?
                        <CustomTab label="Colaboradores"  value={1}/>
                        :null}
                        {(adminState?.PermisosContex?.Modulos?.Colaboradores?.Declinados?.Ver) === true?
                        <CustomTab label="Declinados"  value={2}/>
                        :null}
                        {(adminState?.PermisosContex?.Modulos?.Colaboradores?.Inactivos?.Acceso) === true?
            ...
            <div className="collaborator__container">
                {}
                {tab === 0 && <NuevoIngresoCollaboratorTab value={tab} index={0} />}
                {tab === 1 && <NuevoIngresoCollaboratorTab value={tab} index={1} />}
                {tab === 2 && <NuevoIngresoCollaboratorTab value={tab} index={2} />}
                <ModalState>
                    {tab === 3 && <NuevoIngresoCollaboratorTab value={tab} index={3} />}
                    {tab === 4 && <NuevoIngresoCollaboratorTab value={tab} index={4} />}
                </ModalState>
            </div>
        </div>
    )
