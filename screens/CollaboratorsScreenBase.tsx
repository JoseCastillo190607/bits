        ...
        <div>
            ...
            <Grid
                ...
                >
                    ...
                    :null}
                    {(adminState?.PermisosContex?.Modulos?.Colaboradores?.Administradores?.Acceder) === true?
            ...
            <div className="collaborator__container">
                {tab === 0 && <CandidatesTab value={tab} index={0} />}

                {tab === 1 && <CollaboratorTab value={tab} index={1} />}

                {tab === 2 && <DeclinadoTab value={tab} index={2} />}

                <ModalState>
                    {tab === 3 && <InactiveTab value={tab} index={3} />}
                    {tab === 4 && <AdminTab value={tab} index={4} />}
                </ModalState>
            </div>
        </div>
    )
