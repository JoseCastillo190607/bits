...
const DescartarIDSEModal = () =>{
  ...
  return(
    <Dialog aria-labelledby='costumized-dialog-title' open={state.alertaDescartarIDSE} fullWidth={false}  onClose={handleClose} maxWidth={"md"}>
...
export default DescartarIDSEModal 