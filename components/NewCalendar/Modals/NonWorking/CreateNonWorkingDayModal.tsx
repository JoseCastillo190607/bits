...
const CreateNonWorkingDayModal = ({setDate, date, setNonWorkingDays, nonWorkingDays}:any) => { 
    ...
    const [createNewNonWorkingDay] = useMutation(CREATE_NON_WORKING,{
      refetchQueries:[{query:GET_NON_WORKING_MONTH, variables:{calendarId: parseInt(state._id), initDate: date}}]
    })
