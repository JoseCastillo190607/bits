...
import { cleardeleteNonWorkingDayModal, clearDeleteEditEventModall } from "../../../context/NewCalendarContext/Actions";
...
import { GET_NON_WORKING, DELETE_NON_WORKING, GET_EVENT, DELETE_EVENT } from "../../../Querys/querys";
import { SuccessfulAlert } from "../../../alerts/successAlerts";
import moment from "moment";


const DeleteEvent = ({calendarDate}:any) => {
           ...
           <Dialog open={state.deleteEditEventModal} aria-labelledby="form-dialog-title" maxWidth="sm" fullWidth={true}>
               <div className={styles.dialogContainer}>
                   <div className={styles.centerContainer}>
                       <h3 id="form-dialog-title" data-testid="TitleModal">¿Confirmas eliminar el día Evento?</h3>
                   </div>
                   <div className={styles.centerContainer}>
