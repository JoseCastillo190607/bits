        ...
        <>
            <div className={state.sections[2] >= 100 ? `validate__border` : `novalidate__border`}>
                <Grid direction="row" container spacing={2}>
                    <Grid xs item>
                        <FormControl variant="outlined" fullWidth={true} size="small">
                            ...
                            <Select
                                ...
                                disabled={disabled}
                            >
                                <option value={state.collaborator.contractName || ''} disabled={true}>{state.collaborator.contractName || ''}</option>
                    ...
                    <Grid xs item>
                        <TextField
                            type='number' name="netSalary" defaultValue={state.collaborator.netSalary}
                ...
                <Grid direction="row" container spacing={2}>
                    <Grid xs item>
                        <TextField
                            type='number' name="grossSalary" defaultValue={state.collaborator.grossSalary}
                    ...
                    <Grid xs item>
                        <TextField
                            type='number' name="DS" label="S.D" variant="outlined"
                ...
                <Grid direction="row" container spacing={2}>
                    <Grid xs item>
                        <TextField
                            type='number' name="ISD" defaultValue={state.collaborator.ISD}
                    ...
                    <Grid xs item>
                        <FormControl variant="outlined" fullWidth={true} size="small">
                            ...
                            <Select
                                ...
                                disabled={disabled}
                            >
                                <option value={state.collaborator.Company || ''} disabled={true}>{state.collaborator.Company || ''}</option>
                        ...
                        <Grid xs item>
                            <FormControl variant="outlined" fullWidth={true} size="small">
                                ...
                                <Select
                                    ...
                                    disabled={disabled}
                                >
                                    <option value={state.collaborator.paymentPeridicity || ''} disabled={true}>{state.collaborator.paymentPeridicity || ''}</option>
                        ...
                        <Grid xs item>
                            <FormControl variant="outlined" fullWidth={true} size="small">
                                ...
                                <Select
                                    ...
                                    disabled={disabled}
                                >
                                    <option value={state.collaborator.journey || ''} disabled={true}>{state.collaborator.journey || ''}</option>
                        ...
                        <Grid xs item>
                            <FormControl variant="outlined" fullWidth={true} size="small">
                                ...
                                <Select
                                    ...
                                    disabled={disabled}
                                >
                                    <option value={state.collaborator.nominesPayroll || ''} disabled={true}>{state.collaborator.nominesPayroll || ''}</option>
