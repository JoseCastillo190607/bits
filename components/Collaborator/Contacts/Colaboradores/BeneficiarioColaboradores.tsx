...
const BeneficiarioColaboradores = () => {
    ...
    return (
        ...
        <Box mt={0} pt={1}>
        {(adminState?.PermisosContex?.Modulos?.Colaboradores?.Colaboradores?.Ver?.SaludEmergencias?.Beneficiario?.Editar === true)?
...
export default BeneficiarioColaboradores;