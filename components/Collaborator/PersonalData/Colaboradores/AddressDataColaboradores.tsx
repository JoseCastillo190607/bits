...
const AddressDataColaboradores = () => {
    ...
    return (
        ...
        <Box mt={0} pt={1}>
        {(adminState?.PermisosContex?.Modulos?.Colaboradores?.Colaboradores?.Ver?.DatosPersonales?.DatosDomicilio.Editar === true)?
...
export default AddressDataColaboradores;