...
const AddressDataNuevoIngreso = () => {
    ...
    const UpdateCandidate = async () => {
        // let result = await putCandidate(state.collaborator, state.collaborator.status === "sent" ? 'si' : 'no');
    ...
    return (
        ...
        <Box mt={0} pt={1}>
        {(adminState?.PermisosContex?.Modulos?.Colaboradores?.NuevoIngreso?.Ver?.DatosPersonales?.DatosDomicilio.Editar === true)?
...
export default AddressDataNuevoIngreso;