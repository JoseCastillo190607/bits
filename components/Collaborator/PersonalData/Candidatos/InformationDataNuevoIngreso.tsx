...
const InformationDataNuevoIngreso = () => {
    ...
    return (
        ...
        <Box mt={0} pt={1}>
        {(adminState?.PermisosContex?.Modulos?.Colaboradores?.NuevoIngreso?.Ver?.DatosPersonales.Editar === true)?
...
export default InformationDataNuevoIngreso;