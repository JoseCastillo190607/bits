 ...
 import { GET_ALL_FILES, DELETE_FILES, GET_FILE } from "../../../Querys/querys";
        ...
        <Formik
          ...
          onSubmit={formData => {
            ...
            deleteDocument({
                ...
                SuccessfulAlert({text:"Documento eliminado con éxito"});
            });
            ...
            <Dialog open={state.deleteModal} aria-labelledby="form-dialog-title" maxWidth="sm" fullWidth={true}>
                <div className={styles.dialogContainer}>
                    <div className={styles.centerContainer}>
                        <h3 id="form-dialog-title" data-testid="TitleModal">¿Confirmas eliminar el documento?</h3>
                    </div>
                    <div className={styles.centerContainer}>
