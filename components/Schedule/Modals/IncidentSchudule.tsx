...
export const IncidentSchudule = (props: TabCalendar) => {
    ...
    console.log(parseFloat(totalCantidad.replace('$','').replaceAll(',','')))
        ...
        if(archives === undefined){
            ...
            >
                <File_Helper_Incident
                    ...
                    parametrofrom="ArchivoIncidencias"
                    className="image-file"
                    setArchives={setArchives}fFile_Helper_Incident
                    archives={archives}
                    idIncident="0"
                    image={RemoveFile}
                />
