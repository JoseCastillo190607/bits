...
const CreaPolitica = (props: any) => {
  ...
  const { addPoliticOpen, setAddPoliticOpen, PoliticDispatch } =
    useContext(TabPoliticContext);
  ...
  const initialValues = () => {
    return {
      policy_name: "",
      pantry_value_type: "Porcentual",
      saving_fund_type: "Porcentual",
      restaurant_value_type: "Porcentual",
