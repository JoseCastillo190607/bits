...
import { DELETE_SEDE, GET_ALL_SEDE } from "../../../Querys/querys"
...
const EliminaSede = () =>{
  ...
  return(
    <Dialog open={state.deleteSede} aria-labelledby="form-dialog-title" onClose={handleClose} maxWidth={"md"}>
        <div className={styles.em_container}>
          ...
          <div className={styles.contenedorPrincipal}>
            ...
            <div className={styles.em_titulo}>
              ¿Est&aacute;s seguro de que quieres eliminar la sede?
            </div>
