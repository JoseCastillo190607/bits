...
export const createEditEventModal = ({_id = "",createEditEventModal = true}:any, dispatch: Dispatch<any>):void =>{
...
export const deleteEditEventModal = ({_id = "",deleteEditEventModal = true}:any, dispatch: Dispatch<any>):void =>{
